...
import 'learn_featured_articles_list_view.dart';

class LearnViewFeaturedArticlesBuilder extends StatelessWidget {
  const LearnViewFeaturedArticlesBuilder({
    super.key,
    ...
    return FutureBuilder<List<ArticlesModel>>(
      ...
      builder: (context, snapshot) {
        if (snapshot.connectionState == ConnectionState.waiting) {
          ...
          return LearnViewFeaturedArticlesListView(
